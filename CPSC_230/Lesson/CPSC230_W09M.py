...
'''
import random
someColors = ["red", "pink", "orange", "green", "blue"]
oneColor = someColors[random.randint(0,someColors-1)]
oneColorList = list (oneColor)
random.shuffle (oneColorList)
shuffledColors = ''.join(oneColorList)
