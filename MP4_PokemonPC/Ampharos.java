...
@author Kyla Cabrera
@version 1.5
@see Bulbasaur | Raticate | Pokemon | PC | PCBox | PokemonDriver
*/

/*
Class that represents the Pokemon, Ampharos, inheriting from the Pokemon class
*/
...
public class Ampharos extends Pokemon {
    ...
    */
    public Ampharos(String n, String t, int l, int h, int a, int d) {
        super(n, t, l, h, a, d);
    }
    ...
    */
    public void doCry() {
        System.out.println("PEWEWEERYOO!!!");
    }
}