...
@author Kyla Cabrera
@version 1.5
@see Ampharos | Raticate | Pokemon | PC | PCBox | PokemonDriver
*/
...
public class Bulbasaur extends Pokemon {
    ...
    */
    public Bulbasaur(String n, String t, int l, int h, int a, int d) {
        super(n, t, l, h, a, d);
    }
